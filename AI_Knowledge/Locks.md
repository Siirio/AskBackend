...
LOCKED | Do not create tests unless the user explicitly requests them; Maven runs only on explicit user request | Delivery verification stays user-controlled and test scope must not expand silently | Build, CI, src/test
