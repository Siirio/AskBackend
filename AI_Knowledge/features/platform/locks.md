...
LOCKED | Platform catalog access requires EDIT_CATALOG_DURING_IMPORT AND an active managed-import grant with the matching product/service scope | Permission alone or a grant for the other catalog type must not open arbitrary catalog mutations | CatalogCapabilityService
