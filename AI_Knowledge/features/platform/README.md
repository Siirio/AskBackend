...
- Platform catalog access is indirect: EDIT_CATALOG_DURING_IMPORT alone is not enough — an ACTIVE managed-import grant for the target business is also required. Product actions require PRODUCTS or BOTH scope; service actions require SERVICES or BOTH scope.
