...
The business user sees offer lifecycle and linked catalog objects. The customer sees a discount label/effective price or a non-discount brand label; the internal score boost is never rendered.
