...
This file is archive context. It is not a required backend instruction.
...
- mock timers as backend semantics.
- browser web staging as production architecture.
- screenshot-specific UI requirements.

## Current Direction

Ask should be mobile-first and product-first. Browser prototypes and admin tools can exist, but future backend architecture should be driven by stable APIs, domain rules, supplier data, mobile clients, and integration boundaries.
