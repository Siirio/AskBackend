...
import kz.ask.business.member.application.StaffManagementProcessor;
...
public class StaffController {
    ...
    @DeleteMapping("/api/v1/businesses/{businessId}/staff/{staffId}")
    public ResponseEntity<Void> deletePendingEmployee(@AuthenticationPrincipal AskPrincipal principal,
                                                       @PathVariable UUID businessId,
                                                       @PathVariable UUID staffId) {
        staffProcessor.deletePendingEmployee(principal, businessId, staffId);
