...
public interface BusinessBranchService {
    ...
    BusinessBranchDto create(UUID businessId, UUID cityId, String name, String address,
    ...
    BusinessBranchDto update(UUID branchId, String name, String address, UUID cityId,
                             Boolean onlineOnly, BigDecimal latitude, BigDecimal longitude);
}
