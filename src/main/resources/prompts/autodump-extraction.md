...
- **subcategory_label**: Specific subcategory (can be null)
...
8. Preserve duration, schedule, rental period, and conditions in custom_attributes and price_text when present. Example: "велики на прокат 1 час от 4000тг в час" is SERVICE, category_label "Общее", subcategory_label "Прокат велосипедов", custom_attributes {"Длительность":"1 час"}.
